...
ini_set('display_errors', 'Off');
    ...
    if($count == 1){
        $sql2= "UPDATE user set parola='$parola' where email='$email'";
        $vt->query($sql2);
...
<table>
<tr>
<td>E-Posta:</td><td><input required type="email" name="email"/></td>
</tr>
<tr>
<td>New-Password:</td><td><input required type="password" name="parola"/></td>
</tr>
<tr>
<td></td><td><input style="margin-left:50px;" type="submit" class="btn btn-danger  " value="
Approve"name="onayla"/></td>
